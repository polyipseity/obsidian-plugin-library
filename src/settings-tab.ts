...
> extends PluginSettingTab {
      ...
      setting
        ...
        .addDropdown(
          linkSetting(
            ...
            setTextToEnum(langs, async (value) =>
            ...
            },
            {
              pre: (dropdown) => {
                dropdown.addOptions(
                  Object.fromEntries(
                    langs.map((lang) => [lang, languageNamer(lang)]),
                  ),
                );
              },
            },
      ...
      setting
        ...
        .addButton((button) => {
          button
            ...
            .onClick(() => {
              new EditDataModal(context, settings.value, fixer, {
        ...
        .addButton((button) => {
          button
            .setIcon(i18n.t("asset:settings.all-settings-actions.recover-icon"))
  ...
  protected postMutate(local = false): void {
    const {
      containerEl,
      context: { localSettings, settings },
      ui,
    } = this;
