    ...
    this.element = createChildElement(
      ...
      (element) => {
        ...
        function onInternalLinkClick(ev: MouseEvent): void {
          ...
          href = href.slice(1);
          for (const headingEl of Array.from(
            element.querySelectorAll("*[data-heading]"),
          )) {
...
export namespace DocumentationMarkdownView {
  ...
  export function register(context: PluginContext): Registered {
  ...
  export namespace State {
    ...
    export function fix(self0: unknown): Fixed<State> {
      ...
      return markFixed(self0, {
        ...
        displayTextI18nKey: fixTyped(DEFAULT, unc, "displayTextI18nKey", [
          "string",
          "null",
        ]) as TranslationKey | null,

        iconI18nKey: fixTyped(DEFAULT, unc, "iconI18nKey", [
          "string",
          "null",
        ]) as TranslationKey | null,
      });
